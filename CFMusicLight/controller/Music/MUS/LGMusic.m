...
-(void)setUI{
    ...
    self.TableView.backgroundColor = [UIColor colorWithRed:18/255.0 green:166/255.0 blue:166/255.0 alpha:1.0f];
...
//        cell.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"闹钟背景"]];
        ...
        cell.detailTextLabel.textColor = [UIColor colorWithRed:0.8 green:1 blue:0.8 alpha:1];
        
        cell.detailTextLabel.font = [UIFont systemFontOfSize:16];
        cell.textLabel.textColor = [UIColor colorWithRed:0.8 green:1 blue:0.8 alpha:1];
